...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/frontend-experience/5678c75018e0.png)
...
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 源码示例：实现动态样式       | 代码行数较**多**，约**22**行代码：<br /> ![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/frontend-experience/984121cbbdf1.png) <br />另外还需要配套JS逻辑，实现样式切换，代码示例如下：![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/frontend-experience/9a26fef74749.png) | 代码行数较**少**，约**12**行代码：![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/frontend-experience/ac50952aac75.png) |
| 生产环境代码            | 与源代码相同，包含3个class类名：`.block__div`、`.block__div--color-green`、`.block__div--color-yellow` | 编译后的代码，会自动生成2个唯一哈希字符串作为类名：```.css-1gjlitb:hover {     color: yellow; }  .css-1gjlitb {     backrgound-color: hotpink; }``` ![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/frontend-experience/b322e8f0a7e6.png) |
...
| 代码提示              | 有代码提示 | 有代码提示![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/frontend-experience/dcf34d96fdf1.png)
