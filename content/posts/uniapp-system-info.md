...
// 胶囊与状态栏的间距
const menuButtonInfoAndStatusBarHeightGap =
  menuButtonInfo.top - statusBarHeight;
// 51 - 47 = 4px

// 导航栏内容区高度 = 胶囊上下间距的2倍 + 胶囊高度
const navBarHeight =
  menuButtonInfoAndStatusBarHeightGap * 2 + menuButtonInfo.height;
// 4 * 2 + 32 = 40px
...
const customBarHeight =
  menuButtonInfo.bottom + menuButtonInfoAndStatusBarHeightGap;
// 83 + 4 = 87px
```
