...
function t(n, r) {
  return (console.log("Adding numbers:", n, r), n + r);
}
function e(n, r) {
  return (console.log("Multiplying numbers:", n, r), n * r);
}
export { t as add, e as multiply };
```
...
```javascript
const t = (e) => ({ user: e }),
  n = (e) => `Hello, ${e.user.name}! You are ${e.user.age} years old.`;
```
