...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/performance/603f657f15d3.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/performance/441126f91a57.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/performance/cbae342fa165.png)   
  
### 简要分析

这里我打开掘金首页，选中 Performance 面板中的圆箭头，来看一下页面加载过程中的性能表现：   

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/performance/9bed656ef79e.png)
   
从上到下，依次为概述面板、详情面板。下我们先来观察一下概述面板，了解页面的基本表现：

  ![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/performance/59d575ce8b89.png) 
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/performance/d34a7a8376ce.png)   
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/performance/f0340b485850.png)   
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/performance/ef43127712a6.png)  

然后点击“Generate report”按钮，只需静候数秒，LightHouse 就会为我们输出一个完美的性能报告。   

这里我拿掘金小册首页“开刀”：   

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/performance/7ea658235e83.png)    

稍事片刻，Report 便输出成功了，LightHouse 默认会帮我们打开一个新的标签页来展示报告内容。报告内容非常丰富，首先我们看到的是整体的跑分情况：   

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/performance/cde627ca2c2d.png)

上述分别是页面性能、PWA（渐进式 Web 应用）、可访问性（无障碍）、最佳实践、SEO 五项指标的跑分。孰强孰弱，我们一看便知。

向下拉动 Report 页，我们还可以看到每一个指标的细化评估：   

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/performance/25f84690b1be.png)   
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/performance/4504e7cb6e7b.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/performance/1a302904e935.png) 
   
### 关键时间节点

在 performance 的 timing 属性中，我们可以查看到如下的时间戳：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/performance/b036619441bd.png)
   
这些时间戳与页面整个加载流程中的关键时间节点有着一一对应的关系：   

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/performance/adb3554f70cb.png)
