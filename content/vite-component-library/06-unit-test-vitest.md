---
title: "单元测试（二）：搭建 Vitest 的单元测试环境"
date: 2025-10-06
draft: false
description: ""
tags: ["Vite", "组件库", "vitest", "testing"]
categories: ["Vite"]
series: ["工程化配置"]
series_order: 2
---
...
![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/01c325cd24e7.png)
...
![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/51eaa52408d4.png)

解决的办法就是在 vite.config.ts 中增加一个类型定义声明

![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/f9c435f57d14.png)
...
![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/02e613439a18.png)
...
![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/66cc478cd6ad.png)

上面的测试只是测试了按钮的默认状态。对于按钮组件来讲，它的主要逻辑是根据不同的 props 属性来定制不同的样式。下面我们针对这些逻辑继续编写测试。

![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/c9db40e14541.gif)
