---
title: "加餐：类型系统——导出组件库的类型定义"
date: 2025-10-21
draft: false
description: ""
tags: ["Vite", "组件库", "typescript"]
categories: ["Vite"]
series: ["进阶与开源扩展"]
series_order: 2
---
...
![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/9d10a470ff30.png)
...
![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/a73f9339b07c.png)

但是如果将 utils.ts 编译为 utils.js 文件。这个时候类型定义就会丢失。

![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/8728e2804863.png)

那调用的时候自然也不会有类型检查。

![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/67892eaff956.png)

可以看到调用 add 方法的时候，类型是 any。

如果想要保留类型定义，就需要生成类型定义文件，将类型保留到类型定义文件中 d.ts。这个时候编辑器就可以依据类型定义文件进行类型检查了。

![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/f405191d3060.png)
...
![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/13e87d7b8b54.png)
...
![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/5f7be68df8ca.png)
...
-   copyDtsFiles： 目的是可以自动复制源码中的类型定义，这个需要有。
    ...
    -   ```
        pnpm build
        ```
    -   ![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/ddbe1fbe4151.png)

### 定义类型定义入口

类型定义入口文件是靠编写编译脚本实现的。如何编写这个脚本在后面介绍。现在大家先弄清生成后的样子。对于一个软件包来讲，类型定义文件的位置通过 package.json 的 types 属性确定。

![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/7ef5f0173e05.png)
...
![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/8547bfb4a9e3.png)

具体写法为

![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/f0e92abfc9c4.png)
...
![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/d6cbed8706ed.png)
...
![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/1285c63acc7b.png)
...
![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/3ed298ce1369.png)
