---
title: "README：编写标准的 README"
date: 2025-10-15
draft: false
description: ""
tags: ["Vite", "组件库", "documentation"]
categories: ["Vite"]
series: ["社区运营与质量"]
series_order: 1
---
...
![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/2838ad7f3827.png)
...
![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/f2bcbb203280.png)

- 特性描述精炼准确；
- 字体图标开头提升了页面视觉效果；
- 引用链接完整清晰。

![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/c4b560e33f57.png)
...
![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/4c963bb378c6.png)
...
![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/83fa5d7cd2d6.png)

### Badges 徽章

徽章是一个开源库的品质保证。比如 npm下载量、测试覆盖率、CI运行状况。这些不是普通的字符，每一个徽章都是相应的系统动态生成的，比如 npm 下载量就是由 npm 生成并颁发的。虽然这个可以通过技术手段模拟，但是大家还是要注意自己的素质。

![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/f27f3964fd10.png)

![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/cf03b5ab2022.png)

徽章在 https://shields.io/ 中生成。比如： MIT 证书徽章，访问 https://shields.io/category/license。

![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/497aa2a6bf3e.png)

```HTML
![MIT](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/dace1b615885.svg)
```

颜色字体等内容可以根据页面需要稍微定制一下，让呈现效果更加美观。比如我把 MIT 定义为红色会和前端有点对比。

![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/449fad17432d.png)
...
![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/dd250c40ef79.png)
...
![img](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/f0d9b4121992.png)
