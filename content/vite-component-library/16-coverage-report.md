...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/57ba0a5e54e6.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/7b7c68cd265f.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/174bbc49a74a.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/60f57b2c6a97.png)

还会自动的生成徽章。这个徽章是会根据报告结果动态变化的，属于客观的第三方数据，具有公信力。


![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/dca824b4b5ce.png)

首先需要登录 [Codecov 网站](https://codecov.io/)。


![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/2ad049448b7b.png)

**一定要使用 Github 账号进行登录****，**这样它可以直接读取你的 Github 中的项目。


![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/ec8eebe274c8.png)


![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/57851a1f110c.png)

然后是添加访问授权，如果你的项目在你名下的组织下，也需要访问授权。


![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/540a93f64801.png)

这时候你就可以在网站上找到所有 Github 中的项目。选择 【Not yet setup 】，选择需要展示覆盖率报告的网站后的【 setup repo】链接，就可以看到安装指南。


![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/8c08ad8de627.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/42544c88bd1e.png)

提交代码就可以自动生成覆盖率报告了。


![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/8d2f1bacf793.png)

Codecov Action 会自动识别语言与测试框架的覆盖率报告种类，然后上传相应的数据。这里面要特别说明，对于 Vitest ，是上传的 json 格式的报告，所以需要确定你确实生成了 json 报告。如何生成可以看上文介绍。


![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/21ee0ea91af2.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/044c49b5079e.png)


![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite-component-library/f79e185e11c9.png)
