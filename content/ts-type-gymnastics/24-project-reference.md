---
title: "加餐：用 Project Reference 优化 tsc 编译性能"
date: 2025-04-24
draft: false
description: ""
tags: ["typescript", "type-gymnastics", "tsc", "project-reference"]
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/c9692ed27abb.png)

它们是用同一个 tsconfig.json 来配置编译方式的：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/a4414c7ed59d.png)

执行 tsc 就会编译所有 include 的文件到 dist 目录下：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/93e6c94c5799.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/a79f22111bd0.png)

然后在根目录的 tsconfig.json 里加上一个 references 的配置，引入 aaa 和 bbb：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/79eab41e44db.png)

这样再执行 tsc --build 进行编译，你会发现编译结果多了 .d.ts 的声明，还多了 tsconfig.tsbuildinfo 的文件：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/854ac508ff31.png)

打开 tsconfig.tsbuildinfo 看一下，会发现它记录了编译了哪些文件，还记录了这些文件的 hash 值：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/b41889dcc22a.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/1ecc9c536055.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/5691786f96fe.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/2ef8b21bd615.png)

之后为了优化编译性能，换成 tsc 的 project reference 的方式了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/6da813d042d7.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/93e41d6948fc.jpg)
