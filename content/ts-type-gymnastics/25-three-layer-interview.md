---
title: "加餐：一道 3 层的 ts 面试题"
date: 2025-04-25
draft: false
description: ""
tags: ["typescript", "type-gymnastics", "interview"]
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/c4674e125ab3.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/ecc540d3e454.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/9c11efb16b90.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/d0f2f6c7864a.png)

但是 any 也可以赋值给任何类型，但 unknown 不行。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/b3278b101a44.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/f96bb360fb12.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/1807ba291772.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/6d713ef9ae35.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/9f1af50cb2b1.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/9d1167ac9cc4.png)

但你把它作为返回值加到函数上会报错：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/9b7eea3f2942.png)

因为声明函数的时候都不知道参数是啥，自然计算不出 Zip<Target, Source> 的值，所以这里会类型不匹配：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/5f9b3f85f666.png)

那怎么办呢？

可以用函数重载解决：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/82cd9379bdc3.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/fdf06104233a.png)

咋返回值的类型不对呢？

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/1b28840b2a7e.png)

其实这时候匹配的函数类型是对的，只不过推导出的不是字面量类型。

这时候可以加个 as const。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/4fcb39e62f0f.png)

但是加上 as const 会推导出 readonly [1,2,3]

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/c36780c349d4.png)

这样类型就不匹配了，所以要在类型参数的声明上也加上 readonly:

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/0a3368b8e96a.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/cd2e7d32dec6.png)

可以把索引类型的每个索引都加上 readonly 修饰：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/88c701b4c749.png)

但没有提供去掉 readonly 修饰的高级类型，我们可以自己实现一下：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/434b68fca100.png)

用映射类型的语法构造个新索引类型，加上个 -readonly 就是去掉 readonly 修饰的意思。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/a74b89eedeae.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/331cfb7b5377.png)

（准确来说叫元组，元组是元素个数固定的数组）

那我们只要在传入 Zip 之前，用 Mutable 去掉 readonly 就可以了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/eb97437d159f.png)

再来试一下：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/35e0d83a7657.png)

大功告成！现在返回值的类型就对了。

但还有个问题，如果不是直接传入字面量，是推导不出字面量类型的，这时候貌似就不对了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/f9eb9bc56def.png)

可我们不都声明重载类型了么？

如果推导不出字面量类型，应该匹配这个呀：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/264c418fcaf5.png)

但实际上它匹配的还是第一个：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/d1b8345e3cc9.png)

这时候其实只要调换下两个函数类型的顺序就可以了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/3a152be7375d.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/f26423e11745.png)

这时字面量参数的情况依然也是对的：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/66d31892986f.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/ts-type-gymnastics/c884dbb7c7fc.png)
