...
2. 所有的应用安装新的依赖，并进行联调。
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/249ff99d0641.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/079b976a9e99.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/84916f6170bb.png)

值得强调的是，在模块联邦中，每个模块既可以是`本地模块`，导入其它的`远程模块`，又可以作为远程模块，被其他的模块导入。如下面这个例子所示:

![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/62962c783946.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/b4110eee3180.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/89e27e16a4e2.png)

接下来，我们继续分析共享依赖的实现。拿之前的示例项目来说，本地模块设置了`shared: ['vue']`参数之后，当它执行远程模块代码的时候，一旦遇到了引入`vue`的情况，会优先使用本地的 `vue`，而不是远端模块中的`vue`。

![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/6f3a26b9d4d7.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/4c522d7d10c9.png)
