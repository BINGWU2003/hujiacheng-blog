---
title: "打包完产物体积太大，怎么拆包？"
date: 2025-06-14
draft: false
description: ""
tags: ["vite", "code-splitting", "bundler"]
categories: ["Vite"]
series: ["Vite 高级应用"]
series_order: 3
---
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/c4abba3dd534.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/651fd9356912.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/36843d75c3ca.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/abd7b08987bd.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/36053826c558.png)

看上去好像各个第三方包的 chunk (如`lodash`、`react`等等)都能拆分出来，但实际上你可以运行 `npx vite preview` 预览产物，会发现产物根本没有办法运行起来，页面出现白屏，同时控制台出现如下的报错:


![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/d44a97a9579a.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/35e15811350c.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/62eeaabcfae3.png)

而对于如上打包产物的执行过程也是同理:

![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/a1dba634711b.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/87fb17a49cf1.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/c7250a96b79d.png)

可以发现`react-vendor`可以正常拆分出来，查看它的内容:


![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/cfa695e6e124.png)

从中你可以看出`react`的一些间接依赖已经成功打包到了`react-vendor`当中，执行`npx view preview`预览产物页面也能正常渲染了:


![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/7ee1d7992db7.png)
