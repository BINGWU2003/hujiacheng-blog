---
title: "实现代码打包、Tree Shaking"
date: 2025-06-27
draft: false
description: ""
tags: ["vite", "tree-shaking", "bundler"]
categories: ["Vite"]
series: ["Vite 手写实现"]
series_order: 4
---
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/ebf72336acd2.png)
...
> 建议 fork 小册的 [Github 仓库](https://github.com/sanyuan0704/juejin-book-vite)，从项目根目录下创建项目，因为需要使用仓库中的 ast-parser
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/c9bcfc4a4141.png)

其中 A 依赖 B 和 C，B 和 C 依赖 D，D 依赖 E，那么最后的拓扑排序即`E、D、B、C、A`。但也有一种特殊情况，就是出现循环的情况，如下面这张图所示:

![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vite/103a5c8ec797.png)
