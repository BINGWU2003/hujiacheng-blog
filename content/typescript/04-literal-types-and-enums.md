...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/6a86720ed3bc.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/a62a4ec835f5.png)

![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/5d09fc8e2bb4.png)

你会发现，使用 const 声明的变量，其类型会从值推导出最精确的字面量类型。而对象类型则只会推导至符合其属性结构的接口，不会使用字面量类型：

![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/900d12266489.png)
