---
title: "基于 Prisma + NestJs 的 Node API：项目开发与部署"
date: 2025-03-30
draft: false
description: ""
tags: ["typescript", "prisma", "nestjs"]
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/c36c07e06369.png)

在登录时，如果提示需要 Multi-Factor Auth，可以选择先跳过。完成登录后，它会将你重定向到应用管理页面：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/98fcca188769.png)

点击右上角的新建，选择创建一个新应用，应用名需要是独一无二的：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/818f582316a5.png)

创建成功后，我们会来到应用界面，以我们已经创建完毕的页面为例：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/fece884bc679.png)

点击 Deploy，我们需要把应用和 github 仓库关联起来，这样就能在每次提交时自动重新部署了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/db8b982ab78d.png)

首先选择 Connect to GitHub，授权完毕后选择你对应的仓库，配置完毕后你会看到这样的界面：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/4cee35328fbe.png)

点击 Enable Automatic Deploys 后，我们的应用就会随着每次 Git 提交而重新部署。

另外，我们此前的环境配置其实就是安装了 Heroku 的 CLI ，现在我们需要通过 CLI 在终端也登录上：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/2953120836aa.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/40afbc1c2b97.png)

点击创建一个新的 token，复制它，回到终端运行 `heroku login -i`，账号名输入你的邮箱，密码输入 token，确认登录：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/d982849da8bd.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/80a4ecceef64.png)
...
[![image380be9c6e463109c.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/2af26d0153ff.png)](https://www.imagehub.cc/image/GfiN6y)

点击安装，将安装到我们的应用中：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/8fd478d3f131.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/b88fbe925283.png)

数据库的链接会被以环境变量 `process.env.DATABASE_URL ` 注入进来，来到应用配置页面，点击显示环境变量：

![imagee38ce6a381dc9b3b.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/76d24d3d6803.png)
...
![imagedb88d65589f9bb99.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/b5d0c6e9d233.png)
...
![imagee102f1b42e36a82b.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/172c86f65f72.png)
...
![imagef0c3c4a1ded5150f.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/db5900bd6235.png)

![imagea22f61b473e93e2c.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/460f9aec3a4f.png) 
...
![image752c0cd8664a87c4.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/d608f4c6bb29.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/f0cfa5398f9c.png)

`GET /article`：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/bb05580d782f.png)

`GET /article?id=20`：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/f9d051a61fa0.png)

`POST /article/update`：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/typescript/994e156b4834.png)
