...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vue3/fc8571f11318.png)

而依赖注入则是为了解决 `prop 逐级透传` 的问题而诞生的，父组件 `provide` 需要共享给子组件的数据，子组件 `inject` 使用需要的父组件状态数据，而且可以保持响应式。

![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vue3/87cd28579e5e.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vue3/4a4eb2dbf6ce.png)
