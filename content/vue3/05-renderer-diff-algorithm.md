...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vue3/37839d2ac4b3.png)

第一步执行时，会完成对 `a` 和 `b` 头部这 2 个节点进行 `patch`。当 `i = 2` 时，由于此时的 `c` 和 `e` 节点的 `key` 不一样，所以退出了头部比对流程，进入尾部比对：


![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vue3/49dcbbb9e2d8.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vue3/0255fe4982af.png)

第一步执行时，会完成对 `a` 和 `b` 头部这 2 个节点进行 `patch`。当 `i = 2` 时，由于此时的 `e` 和 `c` 节点的 `key` 不一样，所以退出了头部比对流程，进入尾部比对：


![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vue3/f0aa770258ab.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vue3/7ba3c3956b37.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vue3/a5477c82b92f.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vue3/59c1931dc6a8.png)
...
![image.png](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/vue3/277686d5160b.png)
