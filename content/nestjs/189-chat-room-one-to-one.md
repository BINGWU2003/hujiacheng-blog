...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/abdc741c1b70.png)

这节就来实现下进入聊天的入口。

也就是这两个：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/4f7685c031aa.png)

点击聊天按钮的时候，要创建聊天室，或者查找已有的聊天室，然后带着 id 跳到聊天页面：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/455519e0381a.png)

聊天页面选中 id 对应的聊天室。

给聊天按钮加一个点击事件，点击的时候传入对应用户的 id：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/3be24de6eb6e.png)
```javascript
<a href="#" onClick={() => {
    goToChat(record.id)
}}>聊天</a>
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/686c82d3f2b1.png)

现在没这个接口，我们加一下：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/ea7f1c71be35.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/592d0a415909.png)

现在只有这两个用户在一个聊天室。

结果是对的：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/a6c4aa755c01.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/5c245aca6e37.png)

在组件里调用下：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/0eaa8470b1b7.png)
```javascript
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/d16a1a15d42e.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/324de0c3aea6.gif)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/509c33f8a797.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/13c73b2d7edd.gif)

现在，聊天室名字就和平时用的聊天软件一样了。

我们登录神说要有光账号聊聊天：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/7ccf1e8736a5.gif)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/3c18aa93d79c.gif)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/52e3b4504ca9.png)

登录，添加光为好友：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/11dc73091589.gif)

光这边可以看到这个好友请求，同意之后就可以在好友列表看到了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/06d64f298370.gif)

然后回到小黄鸭这边：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/833523d80ddd.gif)

可以看到好友申请已经通过，可以在好友列表看到光，然后进入聊天：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/2aeb4b19f62d.gif)
