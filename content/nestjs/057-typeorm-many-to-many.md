...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/ff5a4545ccc6.png)

Entity 之间的引用关系，转换为数据库表之间的外键关联的关系。

一对多我们是通过 @OneToMany 和 @ManyToOne 来把 Entity 映射成数据库表：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/4538748b6c3f.png)

它并不需要 @JoinColumn 来指定外键列，因为外键一定在多的那一边。

那多对多呢？

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/f2ffdb120987.png)

前面讲过，在数据库里，我们是通过中间表来保存这种多对多的关系的：

把多对多拆成了两个一对多：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/8679bfbc03f3.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/bcd1060c64c2.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/cf72ed9979aa.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/9ef4ff7e3a8d.png)

把 index.ts 的代码去掉：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/45de6c596acd.png)

然后 npm run start

可以看到它生成了两个 Entity 的建表 sql：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/5ed489a97e68.png)

然后把这两个表删掉，我们来添加多对多的关联关系：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/507250e0f77b.png)

在 Entity 里通过 @ManyToMany 关联。

比如一篇文章可以有多个标签：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/0481dc5abc4e.png)

然后再 npm run start

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/6b293d190377.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/c17e09a807d6.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/b34e57fdaed6.png)

可以看到，3 个标签、2 篇文章，还有两者的关系，都插入成功了。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/e3ff8329b2d9.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/b06f9f82bbe1.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/b3fafaff9874.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/bcfc84f26b9c.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/72da3a2cc777.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/65d3c64801eb.png)

npm run start 跑一下：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/ca68bd3b332e.png)

它会先查出 id 为 2 的 article 有哪些标签，查出了 1、2、3。

然后会把他和 id 为 2 的 article 的关系，(2, 2) (2, 3) 从中间表中删除。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/f2f2a33a47c6.png)

这样就这个 article 就只有 id 为 1 的 tag 了。

此外，更新 article.title 的是另一个 update 语句：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/30fd76071345.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/2c1d97ca05e1.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/e1f0f2671239.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/0e5384be6a8a.png)

一对多的 department 那方，不维护外键，所以需要第二个参数来指定通过哪个外键找到 department：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/0d3f28944ef5.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/dab15a9f0303.png)
