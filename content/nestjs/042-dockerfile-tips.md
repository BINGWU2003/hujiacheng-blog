...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/4abb0c456544.png)

但是，这个容器和宿主机还是有关联的，比如可以把宿主机的端口映射到容器内的端口、宿主机某个目录挂载到容器内的目录。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/304eec324561.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/711148e8cea7.png)
...
```
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/6d918258609f.png)
...
node ./dist/main.js
```
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/4ba4eadd03fa.png)

这时候访问 http://localhost:3000 可以看到 hello world，说明服务跑成功了:

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/07fbf36e7bd0.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/82a1bed3b328.png)

然后在 docker desktop 的 images 里就可以看到这个镜像了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/a64bc89858d4.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/00718fb1412e.png)

然后就可以看到容器部分有了这个容器了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/5e040a8908ba.png)

浏览器访问 http://localhost:2333 就可以访问容器内跑的这个服务：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/37cad6a0bf3e.png)

这就是 Dockerfile 构建成镜像，然后通过容器跑起来的流程。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/989c408d1c09.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/d1667103fa54.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/276455b89922.png)
...
```
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/f1381b91c1f3.png)

这次的 tag 为 second。

然后在 docker desktop 里看下：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/8e8015dd481e.png)

好家伙，足足小了 900M。

我们点开看看：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/5f513d58dab5.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/1d19b2f7e116.png)

docker desktop 可以看到这个跑起来的容器：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/7364381eb878.png)

浏览器访问下，依然是正常的：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/ea0f1910b57d.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/e856722b0b1a.png)
...
docker build -t dockerfile-test:second .
```
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/167cf4b7f03c.png)

现在我们改下 README.md：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/519b9f6c7034.png)

然后重新跑 build：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/58fcfb7edb3a.png)

现在花了 25s，其实是没有重新 npm install 的。

然后改下 package.json：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/1e7910e305b2.png)

再跑 docker build

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/07bb590b3d75.png)

时间明显多了很多，过程中你可以看到在 npm install 那层停留了很长时间。

这就是为什么要这样写：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/b50786f1ee64.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/c1c1cb57c12d.png)

然后 desktop 里看下构建出来的镜像：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/81b25c864fd7.png)

镜像体积比没有用多阶段构建的时候小了 250 M。

然后跑起来试试看：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/98d04597d30a.png)

这次映射 2335 端口到容器内的 3000 端口。

依然能正常访问：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/59626c63cc5f.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/15a79be91e93.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/23d47e00412d.png)


点击查看镜像详情，可以看到 ARG 已经被替换为具体的值了：


![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/25fa88d1b206.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/c1cfa947d080.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/128f7132f4f2.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/599214af24b9.png)

其实还可以写成 ENTRYPOINT：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/350c45917eaf.png)
...
```
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/eeff159a233a.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/9e8090586ce0.png)

没有指定 --name 时，会生成一个随机容器名。

就是这种：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/73106177f32e.png)
...
```
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/7adc2c1c91ad.png)
...
docker build -t cmd-test -f 444.Dockerfile .
```
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/27bafb31aa75.png)
docker run: 
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/b4fa6dfe9a43.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/ff791d82a93c.png)
...
```
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/314237eff14e.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/60a78d9564ac.png)
...
```
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/979ded842488.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/6da463951209.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/c29dbd66442b.png)

可以看到，ADD 把 tar.gz 给解压然后复制到容器内了。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/6e219de4867d.png)

而 COPY 没有解压，它把文件整个复制过去了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/8b1614007e7f.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/83ffcfc6639b.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/f3ea4ad5676a.png)
