...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/a830f1b4f32c.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/99cc5ec10703.png)

通过 @Query 来取 url 中的 query 参数，比如 /user/xx?id=222 里的 222

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/32676056a058.png)

通过 @Body 取 /book/create 的请求体内容：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/fcaedb528f43.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/200be09c68f0.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/5ff1876f6ee2.png)

**service 里做业务逻辑的具体实现，比如操作数据库等**

同理，/book/list、/book/create 接口是在另一个 BookController 里：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/c702963d865b.png)

它的业务逻辑实现也是在 BookService 里。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/e28c92b78cfc.png)

很明显，UserController 和 UserService 是一块的，BookController 和 BookService 是一块的。

所以，Nest 有了模块的划分，每个模块里都包含 controller 和 service：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/3ca68dac1829.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/6cdcb113812c.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/17a1873682ac.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/f2b1245ae9b0.png)

默认的 XxxService 只是一种简化的写法。

还可以直接 useValue 创建，通过 useFactory 创建等。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/a9f81779507f.png)

刚才提到了 IoC 会自动从容器中查找实例来注入，注入的方式有两种：

属性注入和构造器注入。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/7b8955e22319.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/0c7276851c36.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/82e838ff4703.png)

这种逻辑适合放在 controller 里么？

不适合，这种通用逻辑应该通过 interceptor 等方式抽离出来，然后需要用的时候在 controller 上声明一下：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/26a32ed31bf9.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/939668a39aa1.png)

创建项目里的某个新模块：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/af13ddc69345.png)
