...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/2bee8e76a9c8.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/f47de8e94b40.png)

然后通过一种叫做 UnionFS 的机制把这些层合并起来，变成一个文件系统：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/5ca5886d66ad.png)

这样如果有多个容器内做了文件修改，只要创建不同的层即可，底层的基础镜像是一样的。

我们写的这个 Dockerfile，每一行指令都会生成一层镜像：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/97cf8032e433.png)

点开 docker 镜像的详情可以看到：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/a3393b4020ee.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/05bef20e2521.png)

但是很多都是它继承的 node 镜像里的，可以看到每一层用了多少存储空间：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/4998d9b956ae.gif)

我本地两个 nest 镜像，它们都继承了 node 镜像，这两个合起来有 2g 的存储空间么？

没有，因为下面的镜像层是公用的：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/f7f763e06659.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/9340717125b1.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/7e8f3c722c1e.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/211c77e03c9b.png)
