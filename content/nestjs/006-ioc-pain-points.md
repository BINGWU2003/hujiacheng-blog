...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/e4dcc69fb42c.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/aceb9752ec85.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/53c62671e7cc.png)

选择一个 npm 包管理工具，然后 nest cli 会自动创建项目结构并安装依赖：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/c72dc774431d.png)

然后进入这个目录，执行 npm run start，把服务跑起来：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/7aecb94eb016.png)

浏览器访问 http://localhost:3000 就可以看到 nest 服务返回的 hello world：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/67b2b3468e27.png)

我们看看代码里它是怎么创建对象的：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/b06d9c5d83fe.png)

它有一个 AppService 声明了 @Injectable，代表这个 class 可注入，那么 nest 就会把它的对象放到 IOC 容器里。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/ff54931d73d3.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/a2a8e0d1e7da.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/53eccf8ef801.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/3f2c8190a1d7.png)

那么 nest 就会从 AppModule 开始解析 class 上通过装饰器声明的依赖信息，自动创建和组装对象。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/3900a91c61db.png)

所以 AppController 只是声明了对 AppService 的依赖，就可以调用它的方法了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/2bbba41742e5.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/daed49df04ac.png)

会生成如下代码：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/f891af2195fc.png)

用 nest cli 的 generate 命令生成一个模块。

会在 AppModule 里自动 imports 这个模块：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/0a4ff43c287a.png)
...
```
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/3df5eaeaabc6.png)

会生成 Service 的代码：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/1c15d9d6d19c.png)

并自动添加到 OtherModule 的 providers 中：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/b18fa1c68669.png)

我们改下 OtherService，添加一个方法：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/97b7dfb5c253.png)

然后在 OtherModule 里 exports：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/4ca044617998.png)

那当 AppModule 引用了 OtherModule 之后，就可以注入它 exports 的 OtherService 了。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/d5c07f020c79.png)
...
npm run start:dev
```
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/cc0f06a9f29b.png)


浏览器访问下，可以看到 AppModule 的 AppService 调用 OtherModule 的 OtherService 成功了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/2969741e6c3b.png)
