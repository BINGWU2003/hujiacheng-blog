...
```
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/c61c3498143c.png)

然后创建一个 crud 的模块：
```bash
nest g resource user
```
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/a188ce83fccb.png)

生成的 service 里的 crud 并没有真正实现：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/d97da45e9955.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/6946534a24ab.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/8f2427881c79.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/5549887d6265.png)

服务端打印了 insert 的 sql 语句：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/be9dc971d453.png)

表里也可以看到这条数据了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/4923114bcf3e.png)

对应的是这个 handler：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/1ad8035839ef.png)

然后再试下查询：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/68e0e908087f.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/de934ecde74d.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/8b3c8ee5eb92.png)

单个查询和全部查询都是可以的。

再就是修改：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/04d23b7dab03.png)

在 controller 里是接受 patch 的请求。


在 postman 里发一下：
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/923afffb3984.png)



可以看到生成了 update 的 sql 语句：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/48c1e540ce95.png)

数据库中的数据也被修改了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/ca12854c68da.png)

再试试删除：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/f5ccd2239b79.png)

在 postman 里发送 delete 的请求：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/993099bd21b0.png)

可以看到生成了 delete 的 sql 语句：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/38d74f8362a0.png)

数据库里的数据确实被删除了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/aec384ce387f.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/0c6a1ab60194.png)

简便方法就是先 getRepository(User) 拿到 user 对应的 Repository 对象，再调用这些方法。

比如这样：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/84b3de4bd292.png)

那还不如直接注入 User 对应的 Respository 就好了。

Nest 对这个做了封装，在 user 模块引入 TypeOrmModule.forFeature 对应的动态模块，传入 User 的 Entity：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/ae70a21232de.png)

就可以在模块里注入 Repository 了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/8d8acc21e75c.png)

它有的方法和 EntityManager 一样，只是只能用来操作当前 Entity。

此外，你还可以注入 DataSource：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/16edc5df320f.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/75dba437236c.png)

它会引入 TypeOrmCoreModule.forRoot 的动态模块：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/fa2acfa98b90.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/74fc117ca7d7.png)

而创建 entityManager，则是注入 dataSource 取 manager 属性就好了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/aea7a7c67261.png)

然后 TypeOrmModule.forFeature 则是通过全局的 dataSource.getRepository 拿到参数对应的 Repository 对象，作为模块内的 provider。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/451ebfdc3ff1.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/bc04b109a86d.png)
