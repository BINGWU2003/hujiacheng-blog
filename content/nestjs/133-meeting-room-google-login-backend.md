...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/27fea37176a7.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/d2e084a68fe1.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/593d1590974b.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/53f6052c1996.gif)

会跳到这个页面：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/6f36ecf3637b.png)

因为缺少了 username 的信息，你填上之后就可以注册了。

并且它还自动给你登录了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/e764d9423b85.png)

然后退出登录用 google 账号登录一次：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/48ea3e59b59f.gif)
...
nest g module auth
```
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/5476a34c0578.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/35604feef9a1.png)

然后 AuthModule 引入 UserModule：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/d7cba9c6835b.png)

并把 LocalStrategy 声明为 provider。

LocalStrategy 里直接复用 userService.login 来做登录认证：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/44511f3d0b9a.png)

passport 会把返回的 user 信息放在 request.user 上。

然后 user/login 里就不需要手动调用 userService 了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/c0225fe27771.png)

改成这样，用 AuthGuard('local') 来做处理即可，处理完从 reqeust.user 里拿 user 信息：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/2ace327cf315.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/4f0e58c4e0d6.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/4180540179ba.png)

当密码错误：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/d88e4e124c22.png)

用户名密码都正确时：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/22412fcdc0cd.gif)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/04f6ef2a1b16.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/f1fa25059b12.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/b7e2506ac95f.png)

之后在 UserController 添加两个路由：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/3711a650e168.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/2453dc1d01c8.gif)

可以看到，google 的用户信息拿到了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/3b7ae375d9a9.png)

那我们只要在拿到用户信息的时候自动注册下就好了。

在 user.entity.ts 添加 loginType 字段：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/116e096927a4.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/c498778b7811.png)
...
```
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/9f824c95b0a9.png)

生成的迁移类没问题：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/4a3faa4309ce.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/30ef7f3be845.png)

在数据库看一下：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/e8d09a7fe27e.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/282d97ddd931.png)

loginType 列添加成功了。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/e15eb66edc8c.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/2e15159ecbed.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/486bdc07d38f.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/a1a3066a6598.gif)

可以看到，google 授权之后，自动注册并返回了 token 信息，这样带上这个访问就是登录状态了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/1bca681e79b1.png)

数据库里 user 表也插入了该用户的记录：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/14fd2ac73c97.png)

nickName、headPic、username、loginType 都是对的。

后续 refreshToken 的流程不受影响，因为它只是取出 jwt 里的 userId 来查询用户信息并重新生成 token 返回：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/9945e32c5dd4.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/cd0e26892528.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/69a0976b3912.gif)

数据库已经注册了这个 google 账号对应的 user，再次授权，会查询注册的用户信息返回。

可以看到，只执行了 select 语句：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/2fc1b4d44b42.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/1570ee574d0c.png)

在 callback/google 里注入 Response，设置 cookie：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/5fd3a014c79d.png)

然后重定向：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/4ffe31852de0.png)

试一下：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/82cb85208219.gif)

重定向没问题。

cookie 也没问题：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/b57d150afc4e.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/363cffb465e0.png)

此外，我们还要处理下普通的登录，用户名密码登录的时候要过滤下 loginType：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/e5ba15444319.png)
