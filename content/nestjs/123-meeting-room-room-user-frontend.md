...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/6b4f4e258c9b.png)

需要在 / 下添加一个二级路由：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/0fc227f1b142.png)
...
npm run start:dev
```
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/814219f1eec1.gif)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/354fff3d1409.gif)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/2298df17dcdf.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/4eebfc4c16be.png)

其实会议室的接口都是需要登录才能访问的，当时为了测试方便没有加，现在加一下：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/b2da39f00a17.png)

添加 @RequireLogin 装饰器，标识接口需要登录。

并且添加对应的 @ApiBearerAuth 的 swagger 装饰器，代表需要添加 Bearer 的 header。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/e8b05f29293c.gif)

我们现在 postman 里测试下：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/1eaff7a35c2a.png)

这时候直接调用 delete 接口就会提示需要先登录了。

然后我们登录下，拿到 token。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/9b215fbe541b.png)

把它复制到 swagger 文档这里： 

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/8d126d364931.png)

然后点击这个 try it out：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/2d07649dbbd0.png)

数据库中现在有 3 条记录：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/7c358f7c2108.png)

把 id 为 10 那条删掉。

点击 execute：
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/10b9ece8eb9c.png)

swagger 会发送请求，下面会打印响应：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/b098e7051491.png)

这时数据库里就没有这条记录了：
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/0e1201adb6f0.png)

可以直接在 swagger 文档里测试接口，不用 postman 也行。

然后继续写下个接口的 swagger 文档：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/49bd35debbeb.png)

这个接口的参数也是用 @ApiParam 标识，但它的响应不是 string，而是 MeetingRoom。

而我们现在并没有 vo，没地方标识属性：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/b99642e11fac.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/0b46232bcf11.png)
```javascript
@ApiBearerAuth()
@ApiParam({
    name: 'id',
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/3368ba36f001.png)

接下来是 update 接口：

他有两种响应：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/b2010bfde601.png)

分别写一下：
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/bff26f105fc7.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/43aa272de348.png)

因为 update 的 dto 继承了 create 的 dto，所以那里也要加一下：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/c91235f2138d.png)

这样 swagger 文档就对了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/2050db69ceac.png)

然后是 create 接口：

postman 里调用下是这样的：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/c37a40ca1b72.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/44363e69ab81.png)

所以 swagger 装饰器这样写：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/621854d1e4d0.png)
```javascript
@ApiBearerAuth()
@ApiBody({
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/dc184eee5c4a.png)

然后还有最后一个 list 接口：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/9fc9659990f2.png)

它的响应是这样的：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/97372eea509d.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/fde61ec403c0.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/b0c7158cdc2a.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/17264779e38a.png)

最后，在 controller 上加上个 @ApiTags，把下面的接口分到单独一组：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/c29309011797.png)

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/a5009dbd726e.png)
