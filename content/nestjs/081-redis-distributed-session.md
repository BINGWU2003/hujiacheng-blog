---
title: "基于 Redis 实现分布式 session"
date: 2025-03-22
draft: false
description: ""
tags: ["nestjs", "redis", "session"]
categories: ["NestJS"]
series: ["实战技巧"]
series_order: 1
---
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/3543a4cdc6f9.png)

而 jwt 是把所有的用户数据保存在加密后的 token 里返回，客户端只要在 authorization 的 header 里带上 token，服务端就能从中解析出用户数据。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/8fdb51d24c99.png)

jwt 天然是支持分布式的，比如有两个服务器的时候，任何一个服务器都能从 token 出拿到用户数据：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/e373e82b63ee.png)

但是 session 的方式不行，它的数据是存在单台服务器的内存的，如果再请求另一台服务器就找不到对应的 session 了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/9a856eebffbf.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/82d0ea49e9b6.png)
...
```
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/0899a5fc2020.png)
...
```
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/71fe3890dcfd.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/4bdad28c88de.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/4ea7dddb8ce5.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/4e0b0f9c3c43.png)

现在 getSession 返回的是 Record<string, any> 也就是对象类型，但并不知道有啥具体的属性。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/5d4e49692d17.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/fb52c4508ee9.png)

传入类型参数之后，返回的就是该类型了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/bc52a6b0a34b.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/652f521b1ae5.gif)

我们自己实现的 session 就生效了：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/149358aad579.png)

在 Redis Insight 里可以看到 session 的值

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/d761bbef2ef0.png)

而且这个 session 是支持分布式的。


![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/c6c454562fce.png)
