...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/00399dc1fed6.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/cf5aea129813.png)

随便找个有 websocket 的网站，比如知乎就有：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/1d9287e545f5.png)

过滤出 ws 类型的请求，看看这几个 header，是不是就是前面说的那些。

这个 Sec-WebSocket-Key 是 wk60yiym2FEwCAMVZE3FgQ==

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/52f5a8806359.png)

而响应的 Sec-WebSocket-Accept 是 XRfPnS+8xl11QWZherej/dkHPHM=

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/022b08d749d2.png)

我们算算看：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/4b1d303999e7.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/f0b43ec61d7e.png)

全新的协议？那具体是什么样的协议呢？

这样的：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/c12721098ceb.png)

大家习惯的 http 协议是 key:value 的 header 带个 body 的：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/62d74f393365.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/c4ee37470fca.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/d64de943aea1.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/76a8475961f4.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/3b753f9d708b.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/9353e3bfa8f1.png)

这 3 个 header 还有 101 状态码都是我们返回的。

message 里也可以看到发送的消息：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/29c644573ced.png)

再去服务端看看，也收到了这个消息：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/a9a6c45ef3e8.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/17f62c383e5e.png)

我们需要第一个字节的后四位，也就是 opcode。

这样写：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/d27e79845907.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/33a0690be008.png)

第一位是 mask 标志位，后 7 位是 payload 长度。

可以这样取：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/33e81036d567.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/08855d066218.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/e41f65c4839a.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/8071a101524d.png)

这样就拿到了 payload 的长度，然后再用这个长度去截取内容就好了。

但在读取数据之前，还有个 mask 要处理，这个是用来给内容解密的：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/61a3ee89c4bb.png)

读 4 个字节，就是 mask key。

再后面的就可以根据 payload 长度读出来。

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/07476538f8be.png)
```javascript
let realData = null;
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/d5f97400cef6.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/7de1113cf3af.png)

而现在我们能正确解析出其中的数据：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/9f5db0e13190.png)

至此，我们 websocket 协议的解析成功了！

这样的协议格式的数据叫做 frame，也就是帧：

![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/6762e0ee0985.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/ace2d9c99231.png)
```javascript
send(data) {
    let opcode;
    let buffer;
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/c28462e198b9.png)
```javascript
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/f559c8d72eb9.png)
...
![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/c204955a47fb.png)

收到客户端消息后，每两秒回一个消息。


![](https://bing-wu-doc-1318477772.cos.ap-nanjing.myqcloud.com/nestjs/a463c936eb87.gif)
